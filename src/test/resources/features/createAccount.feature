...
Feature: F001: Account creation in ABC Canada 
  I want to create account in ABC Canada using my email id so that I am able to log in using my email

 
  Scenario Outline: TC001 User is able to create account on ABC Canada using email address
    ...
    When I enter an email id "<email_id>"
